...
export const sponsors: Sponsor[] = [
  ...
  makeSponsor('diamond', 'CS Construction'),
  ...
  makeSponsor('platinum', 'eXp Realty'),
  ...
  makeSponsor('platinum', 'Leslie Ford MP'),
  makeSponsor('platinum', 'Stroeder Truck & Trailer'),
  ...
  makeSponsor('platinum', 'Willies Electric'),
  ...
  makeSponsor('gold', 'Forester'),
  makeSponsor('gold', 'Plumbing Heating & AC'),
  ...
  makeSponsor('gold', 'Walkerton GCC'),
  ...
  makeSponsor('silver', 'Best Western Plus @Home Walkerton'),
  ...
  makeSponsor('silver', 'Hair Right Canada'),
  ...
  makeSponsor('silver', "Shockie's Mechanical"),
  ...
  makeSponsor('silver', "Walker's Landing"),
